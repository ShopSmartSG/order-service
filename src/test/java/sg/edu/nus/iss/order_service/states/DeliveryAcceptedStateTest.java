...
class DeliveryAcceptedStateTest extends Constants {
    ...
    @InjectMocks
    private DeliveryAcceptedState deliveryAcceptedState;

    @BeforeEach
    public void setup() {
        MockitoAnnotations.openMocks(this);
        deliveryAcceptedState = new DeliveryAcceptedState(mongoManager, utils, orderDb, orderColl);
    }

    @Test
    public void testUpdateStatus_DelAcceptedStatus_FailedDeliveryUpdate(){
        ...
        Response response = deliveryAcceptedState.updateStatus(orderContext);
        assertEquals(FAILURE, response.getStatus());
        assertEquals("Failed to update delivery status", response.getMessage());
    }

    @Test
    public void testUpdateStatus_DelAcceptedStatus_Success(){
        ObjectNode payload = objectMapper.createObjectNode();
        payload.put(DELIVERY_PARTNER_ID, globalUUID.toString());
