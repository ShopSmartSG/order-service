...
class ReadyStateTest extends Constants {
    ...
    public void setup() {
        ...
        readyState = new ReadyState(mongoManager, utils, orderDb, orderColl);
    }
    ...
    void updateStatus_Success() {
        ...
        Response response = readyState.updateStatus(orderContext);
